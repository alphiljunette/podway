...
const podcasts = [
  { id: 1, title: 'Tech Talk Daily',  author: 'Sarah Kim',    imageUrl: null, description: 'The best of tech every week. AI, startups, development and digital trends.', category: 'Tech',     rating: 4.8, episodeCount: 4, avgDuration: 44 },
  { id: 2, title: 'Brain & Beyond',   author: 'Dr. Leroy',    imageUrl: null, description: 'Explore the mysteries of the human brain, psychology and neuroscience.',      category: 'Science',  rating: 4.6, episodeCount: 3, avgDuration: 41 },
  { id: 3, title: 'Space Pod',        author: 'Nasa Fan Club', imageUrl: null, description: 'Everything about space exploration, missions and astronomy.',                  category: 'Science',  rating: 4.9, episodeCount: 2, avgDuration: 34 },
  { id: 4, title: 'World Stories',    author: 'Marie Dubois', imageUrl: null, description: 'Stories from around the world, told by those who lived them.',                 category: 'Society',  rating: 4.8, episodeCount: 2, avgDuration: 51 },
  { id: 5, title: 'Daily Insight',    author: 'Jean Martin',  imageUrl: null, description: 'A daily dose of ideas, reflections and analysis on our world.',                category: 'Business', rating: 4.6, episodeCount: 2, avgDuration: 20 },
  { id: 6, title: 'Sound Waves',      author: 'Alex Chen',    imageUrl: null, description: 'Music, sound culture and the stories behind audio masterpieces.',              category: 'Culture',  rating: 4.9, episodeCount: 2, avgDuration: 55 },
];

// URLs MP3 publiques fiables — soundhelix accepte les requêtes sans restriction
